...
Command line:
$ ./method -xxx [-nst <int>] [-ntt <int>] [-alpha <real+>] [-beta <real+>] [-ntopics <int>] [-niters <int>] [-odir <string>] [-savestep <int>] [-twords <int>] -dfile <string> [-tfile <string>]
...
-nst: The number of sampling threads. The default value is 4.
-ntt: The number of updater threads. The default value is 1.
